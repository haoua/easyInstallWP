		...
		<form class="needs-validation" novalidate>
		  	...
		  	<div class="form-row">
		    	...
		    	<div class="col-md-3 mb-3" style="text-align: center">
		    		<input class="form-check-input" type="checkbox" name="enableWpDebug" id="defaultCheck1" style="position: relative; margin: 0; margin-top: 0.7em;">
		  	...
		  	<div class="form-row">
		    	...
		    	<div class="col-md-2 mb-3">
		      		<input class="form-check-input" type="checkbox" name="theme1" id="defaultCheck1" value="hestia.1.1.59" style="position: relative; margin: 0; margin-top: 0.7em;">
				  	<label class="form-check-label" for="defaultCheck1">
				    	Hestia
				  	</label>
		    	</div>
